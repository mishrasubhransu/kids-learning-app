...
const HomeButton = ({ to = '/home' }) => (
  <Link
    to={to}
    className="flex items-center gap-2 md:gap-3 px-4 md:px-6 py-3 md:py-4 rounded-2xl bg-yellow-400 hover:bg-yellow-500 motion-safe:active:scale-95 text-gray-900 shadow-md hover:shadow-lg transition-all"
    aria-label="Go home"
  >
